 ...
 * @author Mario W
 */
public class NotasXcusos extends javax.swing.JInternalFrame {
    ConexionBD cone;
    ...
    public NotasXcusos() {
     ...
     public void cargarCombo() {
      ...
      public void consultar(){
       ...
       ResultSet rs = cone3.consultaBD("SELECT est.codEst, est.nomEst, mat.nota FROM estudiantes as est " +
                "INNER JOIN matriculas as mat ON mat.codEst=est.codEst " +
                "INNER JOIN cursos as cur ON cur.codCurso=mat.codCurso " +
                    "WHERE mat.codEst=est.codEst and cur.codCurso="+jComboBox1.getSelectedItem());
        String fila[]= new String[3];
            while(rs.next()){
                fila[0]=rs.getString("est.codEst");
                fila[1]=rs.getString("est.nomEst");
                fila[2]=rs.getString("mat.nota");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            JasperReport report = JasperCompileManager.compileReport ("src/demoproyecto/pdf/Especificos/NotasXcusos.jrxml");
            ...
            JasperExportManager.exportReportToPdfFile(print,"Reportes/Especificos/Notas por Cursos_"+fechaIngresa.getText()+"_"+hour+"."+minutes+".pdf");
            //toma el archivo y lo convierte en pdf // sino se quiere guardar se quita esta linea

            JasperViewer jviewer= new JasperViewer(print,false);
            jviewer.setTitle("Reporte de Notas por Cursos");
