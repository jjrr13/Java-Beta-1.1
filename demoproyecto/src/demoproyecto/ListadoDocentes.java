...
public class ListadoDocentes extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            JasperReport report = JasperCompileManager.compileReport ("src/demoproyecto/pdf/Generales/ListadoDocentes.jrxml");
            ...
            JasperExportManager.exportReportToPdfFile(print,"Reportes/Generales/Informe Docentes_"+fechaIngresa.getText()+"_"+hour+"."+minutes+".pdf");
