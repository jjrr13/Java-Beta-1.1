 ...
 * @author Mario W
 */
public class CursosXestudiantes extends javax.swing.JInternalFrame {
     ConexionBD cone;
     DefaultTableModel modelo;
     int minutes, hour;

    public CursosXestudiantes() {
        initComponents();
        cone= new ConexionBD();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Cursos por Estudiantes");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Connection conn;
            ...
            JasperReport report = JasperCompileManager.compileReport ("src/demoproyecto/pdf/Especificos/CursosXestudiantes.jrxml");
            ...
            JasperExportManager.exportReportToPdfFile(print,"Reportes/Especificos/Cursos por Estudiantes_"+fechaIngresa.getText()+"_"+hour+"."+minutes+".pdf");
            //toma el archivo y lo convierte en pdf // sino se quiere guardar se quita esta linea

            JasperViewer jviewer= new JasperViewer(print,false);
            jviewer.setTitle("Reporte de Cursos por Estudiantes");
